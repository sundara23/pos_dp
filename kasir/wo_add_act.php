...
if ($trx_jenis_pembayaran == 2 ){
    ...
    mysqli_query($config,"INSERT INTO arus_kas VALUES ('','$tgl','$simpan_ke','$kd_toko','$jenis_barang','$trx_dp','','$trx_costumer','Penjualan Percetakan Kredit','$trx_admin_id')");
}else{
    ...
    mysqli_query($config,"INSERT INTO arus_kas VALUES ('','$tgl','$simpan_ke','$kd_toko','$jenis_barang','$trx_lunas','','0','Penjualan Percetakan','$trx_admin_id')");
}

header("location:wo_detail.php?id=$trx_id");