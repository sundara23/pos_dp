...
<div class="content-wrapper">
    ...
    <div class="content">
        <!-- Dashboard content -->
        <div class="row" id="laptahun">
            <div class="rw">
                <div class="col-md-8">
                    <form action="transaksi_tahunan.php" method="get">
                        <div class="row">
                            <div class="col-md-6">
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped table-datatable">
                        ...
                        $data = mysqli_query($config,"select * from transaksi,kostumer where transaksi.trx_customer=kostumer.kostumer_id and transaksi.kd_toko='faskal01' and transaksi.jenis_barang='CTK' and year(trx_date)='$tahun'");
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped table-datatable">
                        ...
                        $data = mysqli_query($config,"select * from transaksi,kostumer where transaksi.trx_customer=kostumer.kostumer_id and transaksi.kd_toko='faskal02' and transaksi.jenis_barang='CTK' and year(trx_date)='$tahun'");
                        while($d=mysqli_fetch_array($data)){
