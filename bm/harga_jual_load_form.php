		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped">
				...
				<tr>
					<th>Harga Jual</th>
					<td>
						<input required="required" name="hargajual" id="hargajual" class="form-control" min="0" type="number">
					</td>
				</tr>
				<tr>
					<th>Jumlah Minimum</th>
					<td>
						<input required="required" name="minimum_qty" id="minimum_qty" class="form-control" value="1" min="0" type="number">
					</td>
				</tr>
				<tr>
					<th></th>
					<td>
						<button class="btn btn-success btnhitung" type="button">Cek Harga</button>
						<br/>
						<br/>						
						<div class="col-md-4 btn btn-default" id="tots">
							----
						</div>
					</td>
				</tr>
				<tr>
					<th></th>
					<td>						
						<input class="btn btn-primary btn-block sembunyi btn-submit" type="submit" value="Tambahkan Harga">						
					</td>
				</tr>
			</table>
		</div>
		...
		<div class="table-responsive">
			<table class="table table-bordered table-striped">
				...
				<tr>
					<th>Harga Jual</th>
					<td>
						<input required="required" name="hargajual" id="hargajual" class="form-control" value="0" min="0" type="number">
					</td>
				</tr>
				<tr>
					<th>Jumlah Minimum</th>
