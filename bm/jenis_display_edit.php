				...
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<form action="jenis_display_update.php" method="post">
								<?php
								$id = $_GET['id'];
								...
								while($d=mysqli_fetch_array($data)){
									...
									<table class="table table-bordered">
										<tr>
											<th width="20%">Nama jenis_display</th>
											<td>
										...
										<tr>
											<th width="20%">HPP</th>
											<td><input type="number" class="form-control" name="hpp" required="required" value="<?php echo $d['jenis_display_hpp']; ?>"></td>
										</tr>																				
										<tr>
											<th></th>
